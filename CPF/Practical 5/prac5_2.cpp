...
int main()
{
    ...
    double avg, per;
    bool registered=false, markreg=false;
...
do{
    ...
    case 2:
        ...
        if(!registered)
        {
            cout<<"Student's Registration Has Not Been Completed.\n Please Go To The 1st Step."<<endl;
            cout<<""<<endl;
            cout<<""<<endl;
            break;
        }
    ...
    case 4:
        ...
        {
            cout<<"Student's Marks Entry Has Not Been Completed.\n Please Go To The 3rd Step."<<endl;
            cout<<""<<endl;
            cout<<""<<endl;
            break;
        }
